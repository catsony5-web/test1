...
const CACHE_NAME = `${CACHE_PREFIX}v185-theme-refresh`;
const APP_FILES = [
  "./",
  "./index.html",
  ...
  "./src/data/constants.js?v=185-theme-refresh",
  ...
  "./src/features/app/state.js?v=185-theme-refresh",
  ...
  "./src/features/board/board-cards.js?v=185-theme-refresh",
