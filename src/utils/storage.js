...
function normalizeIpoRecord(item) {
  ...
  return {
    ...
    scheduleFingerprint: String(item?.scheduleFingerprint || "").trim(),
    scheduleStatus: String(item?.scheduleStatus || "").trim(),
    scheduleSourceUrl: String(item?.scheduleSourceUrl || "").trim(),
    scheduleSyncedAt: String(item?.scheduleSyncedAt || "").trim(),
    calculationVersion,
    reportedProfit,
    reportedProfitRate,
    hasReportedProfit,
